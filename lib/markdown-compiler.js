...
module.exports = function(source) {
    ...
    const vmdOptions = this._compilation.__vmdOptions__;
    let opts = vmdOptions ? Object.create(vmdOptions.__proto__) : {}; // inherit prototype
    let preventExtract = false;
  
    opts = Object.assign(opts, params, vmdOptions); // assign attributes
